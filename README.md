...
solidbox x0 x1 y0 y1 z0 z1 #在初始时候增加一个固体的长方体。注意，solidbox会覆盖掉下面的box，所以你需要将它写在场景文件的最前面。
box x0 x1 y0 y1 z0 z1 #在初始时候增加一个装满水的长方体，坐标为闭区间[x0,x1],[y0,y1],[z0,z1]。水的初始速度为0。
